                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.categories.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group">
                                <label for="type_code">{{ __('category_type_lang::app.categories.type') }}</label>
                                <select class="control" id="type_code" name="type_code" data-vv-as="&quot;{{ __('admin::app.catalog.categories.visible-in-menu') }}&quot;">

                                    <option value="" readonly >Select Type</option>

                                    @foreach ($category_type as $type)

                                    <option value="{{$type->code}}" {{ $type->code == $category->type_code ? 'selected' : '' }}>
                                        {{$type->name}}
                                    </option>
