<div class="table">
    ...
    @if (isset($results['paginated']) && $results['paginated'])
        @include('shopadmin_ui::datagrid.pagination', ['results' => $results['records']])
    @endif
    ...
    @push('scripts')
        <script type="text/x-template" id="datagrid-filters">
            <div class="grid-container">
                ...
                <table class="table">
                    @include('shopadmin_ui::datagrid.partials.mass-action-header')

                    @include('shopadmin_ui::datagrid.partials.default-header')

                    @include('shopadmin_ui::datagrid.body', ['records' => $results['records'], 'actions' => $results['actions'], 'index' => $results['index'], 'columns' => $results['columns'],'enableMassActions' => $results['enableMassActions'], 'enableActions' => $results['enableActions'], 'norecords' => $results['norecords']])
                </table>
            </div>
        </script>
