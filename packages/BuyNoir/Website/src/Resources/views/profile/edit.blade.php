...
@section('page_title')
    {{ __('career_lang::app.career.edit_title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.career.update') }}">
            ...
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('career_lang::app.career.update-btn-title') }}
                    </button>
                </div>
            </div>
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <input type="text" hidden name="id" value="{{$career->id}}">
                    ...
                    <accordian :title="'{{ __('career_lang::app.account.general') }}'" :active="true">
                        <div slot="body">
                            <div class="control-group" :class="[errors.has('position') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="position" v-validate="'required'" value="{{$career->position}}" data-vv-as="&quot;{{ __('career_lang::app.career.position') }}&quot;" >
                            ...
                            <div class="control-group" :class="[errors.has('vacancy') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="vacancy" v-validate="'required'" value="{{$career->vacancy}}" data-vv-as="&quot;{{ __('career_lang::app.career.vacancy') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('responsibility') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="responsibility" name="responsibility" data-vv-as="&quot;{{ __('career_lang::app.career.responsibility') }}&quot;">{{$career->responsibility}}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('employment_status') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="employment_status" v-validate="'required'" value="{{$career->employment_status}}" data-vv-as="&quot;{{ __('career_lang::app.career.employment_status') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('skill_type') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="skill_type" v-validate="'required'" value="{{$career->skill_type}}" data-vv-as="&quot;{{ __('career_lang::app.career.skill_type') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('educational_requirement') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="educational_requirement" name="educational_requirement" data-vv-as="&quot;{{ __('career_lang::app.career.educational_requirement') }}&quot;">{{$career->educational_requirement}}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('aditional_requirement') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="aditional_requirement" name="aditional_requirement" data-vv-as="&quot;{{ __('career_lang::app.career.aditional_requirement') }}&quot;">{{$career->aditional_requirement}}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('job_location') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="job_location" v-validate="'required'" value="{{$career->job_location}}" data-vv-as="&quot;{{ __('career_lang::app.career.job_location') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('salary') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="salary" v-validate="'required'" value="{{$career->salary}}" data-vv-as="&quot;{{ __('career_lang::app.career.salary') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('compensation') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="compensation" name="compensation" data-vv-as="&quot;{{ __('career_lang::app.career.compensation') }}&quot;">{{$career->compensation}}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('deadline') ? 'has-error' : '']">
                                ...
                                <input type="date" class="control" name="deadline" v-validate="'required'" value="{{date('Y-m-d', strtotime($career->deadline)) }}" data-vv-as="&quot;{{ __('career_lang::app.career.deadline') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                                ...
                                <input type="email" class="control" name="email" v-validate="'required'" value="{{$career->email}}" data-vv-as="&quot;{{ __('career_lang::app.career.email') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('job_status') ? 'has-error' : '']">
                                ...
                                <select id="job_status" class="control" name="job_status" v-validate="'required'" data-vv-as="&quot;{{ __('career_lang::app.career.job_status') }}&quot;">
